// modules/deepSkyExplorer/hooks/useAladin.js
// FULL REPLACEMENT.
//
// Change from the previous version: `hips` is now a direct tile URL rather than
// a registry ID. A.imageHiPS in this aladin-lite build cannot resolve CDS IDs —
// it rejected both 'P/DSS2/color' and 'CDS/P/DSS2/color' with "does not refer to
// a found CDS ID", and those failed lookups were what made band switching slow.
// URLs came from the MOCServer hips_service_url field.
//
// `id` is kept separately because the backend coverage check works on registry
// IDs, not URLs.
