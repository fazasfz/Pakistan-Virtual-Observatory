/**
 * Renders a single instructional step card within the OnboardingTour.
 * Displays title, description, image, and navigation controls.
 * Props: step (object), onNext, onSkip, isLast, totalSteps, currentStepIndex.
 */
